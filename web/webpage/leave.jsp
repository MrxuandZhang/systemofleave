...
<body>
<br>
<fieldset style="margin-top: 45px; margin-left: 34px;  width: 1073px;  height: 460px;  padding-top: 29px;" >
    <legend>请假申请</legend>

<form id="leaveForm" class="layui-form" action="leave/addLeave" method="post" enctype="multipart/form-data">
    <input type="hidden" name="saveleave" id="id_hide" value="no"/>
    <input type="hidden" name="leaNo" value="<%=CommonUtil.getTime()%>" id="id_leaNo"/>
    <%--<div class="layui-inline">--%>
        <%--<label class="layui-form-label">开始时间:</label>--%>
        <%--<div class="layui-input-block">--%>
            <%--<input type="text"  required  lay-verify="date" name="begin" readonly id="begin" autocomplete="off" class="layui-input">--%>
    ...
    <div class="layui-form-item" >
        ...
        <div class="layui-input-block" style="width: 27%;">
            <input type="text"  required  lay-verify="required"  name="begin" readonly id="begin" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item" >
      <label class="layui-form-label">结束时间:</label>
         <div class="layui-input-block" style="width: 27%;">
            <input type="text"  required  lay-verify="required" name="end" readonly id="end"  autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block" style="width:27%;">
            <textarea name="reasonContent" placeholder="请输入内容" required class="layui-textarea"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo" onclick="this.form.submit();">立即提交</button>
            <button type="button" class="layui-btn layui-btn-primary" onclick="toSave()">保存</button>
